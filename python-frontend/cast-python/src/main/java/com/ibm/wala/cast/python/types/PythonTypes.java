...
public class PythonTypes extends AstTypeReference {
    ...
    public static final TypeReference staticMethod = TypeReference.findOrCreate(pythonLoader, TypeName.findOrCreate("Lstaticmethod"));
    public static final TypeReference classMethod = TypeReference.findOrCreate(pythonLoader, TypeName.findOrCreate("Lclassmethod"));

    public static final CAstType cAstDynamicAnnotation = new CAstType() {
        @Override

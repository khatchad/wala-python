...
public class TestLibrary extends TestPythonLibraryCallGraphShape {
    ...
    protected static final Object[][] assertionsLib1 = new Object[][]{
            new Object[]{ROOT, new String[]{"script lib1.py", "script lib1.py/es1", "script lib1.py/es2", "script lib1.py/es3"}},
    ...
    @Ignore
    @Test
    public void testLib1() throws ClassHierarchyException, IllegalArgumentException, CancelException, IOException {
